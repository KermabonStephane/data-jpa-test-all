...
class EmployeeServiceTest {
    ...
    @Test
    @DisplayName("We should have no employee. DataJpaTest will create the schema with hibernate, but does not inject data")
    void test_init() {
    ...
    void test_statement() {
        ...
        Assertions.assertThat(johnByrne.getFirstname()).isEqualTo("Chris");
        Assertions.assertThat(johnByrne.getLastname()).isEqualTo("Claremont");
    }
